...
var oc$Pervasives$ =
  function () {
    var failwith$1026 = _f(1, function (s$1027) { throw $(Failure$19g, s$1027); });
    var invalid_arg$1028 = _f(1, function (s$1029) { throw $(Invalid_argument$18g, s$1029); });
    var Exit$1030 = $("Pervasives.Exit");
    var min$1038 = _f(2, function (x$1039, y$1040) { if (caml_lessequal(x$1039, y$1040)) return x$1039; return y$1040; });
    var max$1041 = _f(2, function (x$1042, y$1043) { if (caml_greaterequal(x$1042, y$1043)) return x$1042; return y$1043; });
    var abs$1060 = _f(1, function (x$1061) { if (x$1061 >= 0) return x$1061; return -x$1061; });
    var lnot$1065 = _f(1, function (x$1066) { return x$1066 ^ -1; });
    ...
    var $5E$1128 = _f(2, function (s1$1129, s2$1130) { return s1$1129.toString() + s2$1130.toString(); });
    var char_of_int$1133 =
      _f(1, function (n$1134) { if (n$1134 < 0 || n$1134 > 255) return __(invalid_arg$1028, [ "char_of_int" ]); return n$1134; });
    var string_of_bool$1140 = _f(1, function (b$1141) { if (b$1141) return "true"; return "false"; });
    ...
    var string_of_int$1143 = _f(1, function (n$1144) { return caml_format_int("%d", n$1144); });
    var String$1147 = $();
    ...
    var string_of_float$1153 =
      _f(1, function (f$1154) { return __(valid_float_lexem$1148, [ caml_format_float("%.12g", f$1154) ]); });
    var $40$1156 =
      _f(2,
         function (l1$1157, l2$1158) { if (l1$1157) return $(l1$1157[0], _($40$1156, [ l1$1157[1], l2$1158 ])); return l2$1158; });
    ...
    var open_out_gen$1188 =
      _f(3,
         function (mode$1189, perm$1190, name$1191) {
           return caml_ml_open_descriptor_out(caml_sys_open(name$1191, mode$1189, perm$1190));
         });
    var open_out$1192 =
      _f(1, function (name$1193) { return __(open_out_gen$1188, [ $(1, $(3, $(4, $(7, 0)))), 438, name$1193 ]); });
    var open_out_bin$1194 =
      _f(1, function (name$1195) { return __(open_out_gen$1188, [ $(1, $(3, $(4, $(6, 0)))), 438, name$1195 ]); });
    var flush_all$1198 =
      _f(1,
         function (param$1400) {
           var iter$1199 =
    ...
    var output_string$1204 = _f(2, function (oc$1205, s$1206) { return caml_ml_output(oc$1205, s$1206, 0, s$1206.length); });
    var output$1207 =
      _f(4,
         function (oc$1208, s$1209, ofs$1210, len$1211) {
    ...
    var output_value$1215 = _f(2, function (chan$1216, v$1217) { return caml_output_value(chan$1216, v$1217, 0); });
    var close_out$1222 = _f(1, function (oc$1223) { caml_ml_flush(oc$1223); return caml_ml_close_channel(oc$1223); });
    ...
    var open_in_gen$1227 =
      _f(3,
         function (mode$1228, perm$1229, name$1230) {
           return caml_ml_open_descriptor_in(caml_sys_open(name$1230, mode$1228, perm$1229));
         });
    var open_in$1231 = _f(1, function (name$1232) { return __(open_in_gen$1227, [ $(0, $(7, 0)), 0, name$1232 ]); });
    var open_in_bin$1233 = _f(1, function (name$1234) { return __(open_in_gen$1227, [ $(0, $(6, 0)), 0, name$1234 ]); });
    var input$1237 =
      _f(4,
         function (ic$1238, s$1239, ofs$1240, len$1241) {
    ...
    var unsafe_really_input$1242 =
      _f(4,
         function (ic$1243, s$1244, ofs$1245, len$1246) {
    ...
    var really_input$1248 =
      _f(4,
         function (ic$1249, s$1250, ofs$1251, len$1252) {
      ...
      _f(1,
         function (chan$1255) {
           var build_result$1256 =
             _f(3,
                function (buf$1257, pos$1258, param$1397) {
                  if (param$1397) {
                    {
    ...
    var close_in_noerr$1276 =
      _f(1, function (ic$1277) { try { return caml_ml_close_channel(ic$1277); } catch (exn$1396) { return 0; } });
    var print_char$1279 = _f(1, function (c$1280) { return caml_ml_output_char(stdout$1166, c$1280); });
    var print_string$1281 = _f(1, function (s$1282) { return __(output_string$1204, [ stdout$1166, s$1282 ]); });
    var print_int$1283 =
      _f(1, function (i$1284) { return __(output_string$1204, [ stdout$1166, _(string_of_int$1143, [ i$1284 ]) ]); });
    var print_float$1285 =
      _f(1, function (f$1286) { return __(output_string$1204, [ stdout$1166, _(string_of_float$1153, [ f$1286 ]) ]); });
    ...
    var print_newline$1289 =
      _f(1, function (param$1395) { caml_ml_output_char(stdout$1166, 10); return caml_ml_flush(stdout$1166); });
    var prerr_char$1290 = _f(1, function (c$1291) { return caml_ml_output_char(stderr$1167, c$1291); });
    var prerr_string$1292 = _f(1, function (s$1293) { return __(output_string$1204, [ stderr$1167, s$1293 ]); });
    var prerr_int$1294 =
      _f(1, function (i$1295) { return __(output_string$1204, [ stderr$1167, _(string_of_int$1143, [ i$1295 ]) ]); });
    var prerr_float$1296 =
      _f(1, function (f$1297) { return __(output_string$1204, [ stderr$1167, _(string_of_float$1153, [ f$1297 ]) ]); });
    ...
    var prerr_newline$1300 =
      _f(1, function (param$1394) { caml_ml_output_char(stderr$1167, 10); return caml_ml_flush(stderr$1167); });
    var read_line$1301 = _f(1, function (param$1393) { caml_ml_flush(stdout$1166); return __(input_line$1254, [ stdin$1165 ]); });
    var read_int$1302 = _f(1, function (param$1392) { return caml_int_of_string(_(read_line$1301, [ 0 ])); });
    var read_float$1303 = _f(1, function (param$1391) { return caml_float_of_string(_(read_line$1301, [ 0 ])); });
    var LargeFile$1310 = $();
    var $5E$5E$1325 =
      _f(2, function (fmt1$1326, fmt2$1327) { return _($5E$1128, [ fmt1$1326, _($5E$1128, [ "%,", fmt2$1327 ]) ]); });
    ...
    var at_exit$1335 =
      _f(1,
         function (f$1336) {
           ...
           return exit_function$1334[0] = _f(1, function (param$1390) { _(f$1336, [ 0 ]); return __(g$1337, [ 0 ]); });
         });
    var do_at_exit$1338 = _f(1, function (param$1389) { return __(exit_function$1334[0], [ 0 ]); });
    var exit$1339 = _f(1, function (retcode$1340) { _(do_at_exit$1338, [ 0 ]); return caml_sys_exit(retcode$1340); });
    ...
    return $(invalid_arg$1028, failwith$1026, Exit$1030, min$1038, max$1041, abs$1060, max_int$1071, min_int$1070, lnot$1065,
             ...
             open_out_bin$1194, open_out_gen$1188, _f(1, function (prim$1357) { return caml_ml_flush(prim$1357); }),
             flush_all$1198, _f(2, function (prim$1359, prim$1358) { return caml_ml_output_char(prim$1359, prim$1358); }),
             output_string$1204, output$1207,
             _f(2, function (prim$1361, prim$1360) { return caml_ml_output_char(prim$1361, prim$1360); }),
             _f(2, function (prim$1363, prim$1362) { return caml_ml_output_int(prim$1363, prim$1362); }), output_value$1215,
             _f(2, function (prim$1365, prim$1364) { return caml_ml_seek_out(prim$1365, prim$1364); }),
             _f(1, function (prim$1366) { return caml_ml_pos_out(prim$1366); }),
             _f(1, function (prim$1367) { return caml_ml_channel_size(prim$1367); }), close_out$1222, close_out_noerr$1224,
             _f(2, function (prim$1369, prim$1368) { return caml_ml_set_binary_mode(prim$1369, prim$1368); }), open_in$1231,
             open_in_bin$1233, open_in_gen$1227, _f(1, function (prim$1370) { return caml_ml_input_char(prim$1370); }),
             input_line$1254, input$1237, really_input$1248, _f(1, function (prim$1371) { return caml_ml_input_char(prim$1371); }),
             _f(1, function (prim$1372) { return caml_ml_input_int(prim$1372); }),
             _f(1, function (prim$1373) { return caml_input_value(prim$1373); }),
             _f(2, function (prim$1375, prim$1374) { return caml_ml_seek_in(prim$1375, prim$1374); }),
             _f(1, function (prim$1376) { return caml_ml_pos_in(prim$1376); }),
             _f(1, function (prim$1377) { return caml_ml_channel_size(prim$1377); }),
             _f(1, function (prim$1378) { return caml_ml_close_channel(prim$1378); }), close_in_noerr$1276,
             _f(2, function (prim$1380, prim$1379) { return caml_ml_set_binary_mode(prim$1380, prim$1379); }),
             $(_f(2, function (prim$1382, prim$1381) { return caml_ml_seek_out_64(prim$1382, prim$1381); }),
               _f(1, function (prim$1383) { return caml_ml_pos_out_64(prim$1383); }),
               _f(1, function (prim$1384) { return caml_ml_channel_size_64(prim$1384); }),
               _f(2, function (prim$1386, prim$1385) { return caml_ml_seek_in_64(prim$1386, prim$1385); }),
               _f(1, function (prim$1387) { return caml_ml_pos_in_64(prim$1387); }),
               _f(1, function (prim$1388) { return caml_ml_channel_size_64(prim$1388); })), string_of_format$1328, $5E$5E$1325,
             exit$1339, at_exit$1335, valid_float_lexem$1148, unsafe_really_input$1242, do_at_exit$1338);
  }();
var oc$Ocamljs$ =
  function () {
    var option_of_nullable$1046 = _f(1, function (x$1047) { if (x$1047 === null) return 0; return $(x$1047); });
    var nullable_of_option$1048 = _f(1, function (x$1049) { if (x$1049) return x$1049[0]; return null; });
    var is_null$1051 = _f(1, function (a$1052) { return caml_equal(a$1052, null); });
...
var oc$Main$ =
  function () {
    var hello$1030 =
      _f(1,
         function (param$1034) {
           return function () { var v$1035 = oc$Dom$[0]; return __m(v$1035.alert, v$1035, [ "Hello, ocamljs!" ]); }();
         });
    var main$1031 = (oc$Dom$[0]).onload = hello$1030;
    return $(hello$1030, main$1031);
  }();
